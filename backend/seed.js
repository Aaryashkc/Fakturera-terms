...
const termsContent = {
  ...
  sv: {
    ...
    text: `
      <p>Genom att trycka på Fakturera Nu, väljer du att registrera dig enligt den information som du har skrivit in och den text på <p>
      GENOM ATT klicka på Fakturera Nu så väljer ni att registrera enligt den information som ni har lagt in och texten på registrerings sidan och villkoren här, och accepterar samtidigt villkoren här.
      </p>
      <p>
...
async function seed() {
  try {
    ...
    await Terms.bulkCreate([
      {
        lang: "en",
        title: termsContent.en.title,
        button: termsContent.en.button,
        text: termsContent.en.text,
      },
      {
        lang: "sv",
        title: termsContent.sv.title,
        button: termsContent.sv.button,
        text: termsContent.sv.text,
      },
    ]);
